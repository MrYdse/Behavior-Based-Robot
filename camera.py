...
class Camera:
    ...
    def sensor_get_value(self):
        ...
        os.system('raspistill -t 1 -o image.png -w "' + str(self.img_width) + '" -h "' + str(self.img_height) +
                  '" -rot "' + str(self.img_rot) + '" -th 0:0:0 -n')
        # raspistill -v -o image.png -w 48 -h 36 -th 0:0:0 -n
